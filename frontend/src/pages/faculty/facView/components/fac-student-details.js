    ...
    <div>
      <div className="student-info-grid-item" key={student._id}>
        ...
        <div className="view1">
          ...
          >
            <img className ='viewImage'src={view} />
          </button>
          <button onClick={() => handleDeleteButtonClick(student._id)} className="deleteBtn">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 69 14"
              class="delete-svgIcon delete-bin-top"
            >
            ...
            <svg
              ...
              fill="none"
              viewBox="0 0 69 57"
              class="delete-svgIcon bin-bottom"
            >
